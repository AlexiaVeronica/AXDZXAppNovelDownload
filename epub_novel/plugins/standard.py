        ...
        if len(root.find('body')) != 0:
            ...
            for _item in body.iter():
                ...
                if _item.tag == 'a':
                    ...
                    leave_only(_item,
                               ATTRIBUTES_GLOBAL + ['alt', 'coords', 'shape', 'href', 'target', 'download', 'rel',
                                                    'hreflang', 'type'])
                elif _item.tag == 'audio':
                    leave_only(_item,
                               ATTRIBUTES_GLOBAL + ['src', 'crossorigin', 'preload', 'autoplay', 'mediagroup', 'loop',
                                                    'muted', 'controls'])
                elif _item.tag == 'blockquote':
                    leave_only(_item, ATTRIBUTES_GLOBAL + ['cite'])
                elif _item.tag == 'button':
                    leave_only(_item, ATTRIBUTES_GLOBAL + ['autofocus', 'disabled', 'form', 'formaction', 'formenctype',
                    ...
                    leave_only(_item,
                               ATTRIBUTES_GLOBAL + ['accept-charset', 'action', 'autocomplete', 'enctype', 'method',
                                                    'name', 'novalidate', 'target'])
                elif _item.tag == 'iframe':
                    leave_only(_item,
                               ATTRIBUTES_GLOBAL + ['src', 'srcdoc', 'name', 'sandbox', 'seamless', 'allowfullscreen',
                                                    'width', 'height'])
                elif _item.tag == 'img':
                    ...
                    leave_only(_item,
                               ATTRIBUTES_GLOBAL + ['accept', 'alt', 'autocomplete', 'autofocus', 'checked', 'dirname',
                                                    'disabled', 'form', 'formaction', 'formenctype', 'formmethod',
                                                    'formnovalidate',
                                                    'formtarget', 'height', 'inputmode', 'list', 'max', 'maxlength',
                                                    'min', 'multiple',
                    ...
                    leave_only(_item,
                               ATTRIBUTES_GLOBAL + ['autofocus', 'challenge', 'disabled', 'form', 'keytype', 'name'])
                    ...
                    leave_only(_item,
                               ATTRIBUTES_GLOBAL + ['data', 'type', 'typemustmatch', 'name', 'usemap', 'form', 'width',
                                                    'height'])
                elif _item.tag == 'ol':
                    ...
                    leave_only(_item,
                               ATTRIBUTES_GLOBAL + ['autofocus', 'disabled', 'form', 'multiple', 'name', 'required',
                                                    'size'])
                    ...
                    leave_only(_item,
                               ATTRIBUTES_GLOBAL + ['autocomplete', 'autofocus', 'cols', 'dirname', 'disabled', 'form',
